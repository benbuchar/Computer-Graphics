...
function init()
{
    ...
    var texSize = 1024;
    var rawData = context.getImageData(0,0,texSize,texSize).data;
    ...
    gl.bufferData( gl.ARRAY_BUFFER, flatten(binormals), gl.STATIC_DRAW );

    var vBinormal = gl.getAttribLocation(program, "vBinormal");
    gl.vertexAttribPointer(vBinormal, 3, gl.FLOAT, false, 0,0);
    gl.enableVertexAttribArray(vBinormal);
